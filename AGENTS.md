...
These guidelines define how an AI agent should approach development tasks for this project.
...
Before beginning development tasks, read **CONTRIBUTING.md** for guidance on:
- Directory structure and organization
- Creating reusable components in the `/src` directory
- Adding pages with static and dynamic routing
